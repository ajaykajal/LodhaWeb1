$("select").html(`
    ...
    `)
var id;$('[data-target][data-toggle=modal]').on('click',function(){id=$(this).attr('data-target');Title={'Homemeeting':"Put your interests in action, get all the details right now.",'DownloadBrochure':"Mention your whatsapp number to receive Brochure on whatsapp",'PriceSection':"Get explicit details about the pricing and on spot offers",'FloorPlan':"You are trying to download a big file, get it on Whatsapp",'Location':"Due to huge rush at site we would request you to book your site visit in advance",'Gallery':"Inside features of the project at a glance",'video_call':'Virtual Zoom Meetings - With the Experts','default':"PLEASE SHARE YOUR DETAILS. OUR SALES EXPERT WILL CALL YOU SHORTLY",'instant':"Instant Call Back"}
$('.modal.form h4').text(Title[id])
$('.modal.form').attr('id',id).modal('show');});var projectId;var RegNo;var city;let apiDataGet=async()=>{let data=getProjectData(1426).then((data)=>{phone_no=data.result.phone;whatsapp_url=data.result.wp_links_sms;whatsapp_url=whatsapp_url.split("=");whatsapp_url[2]="I want to know more about "+whatsapp_url[2];whatsapp_url=whatsapp_url.join("=");projectId=data.result.Project.p_id;city=data.result.Project.Region.city;RegNo=data.result.Project.Region.region_name;$(".phone_url").attr("href","tel:"+phone_no+"");$(".whatsapp_url").attr("href",whatsapp_url+".");$(".phone_no").html(phone_no);}).catch((error)=>{var whatsapp_url="https://api.whatsapp.com/send?phone=917304412403&text=Hi!"
$(".whatsapp_url").attr("href",whatsapp_url);$(".phone_url").attr("href","tel:"+917304927701+"");$(".phone_no").html("917304927701")});}
apiDataGet();var param_nationality=1;function OnlyAlphaValidationWithSpace(e){if(navigator.appName.toLowerCase()=='netscape'){var key1;var keychar1;key1=e.which;keychar1=String.fromCharCode(key1);if((key1==null)||(key1==0)||(key1==8)||(key1==9)||(key1==27)||(key1==46)||(key1==22)){return true;}else if((("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ").indexOf(keychar1)>-1)){return true;}else{return false;}}else{key1=e.keyCode;keychar1=String.fromCharCode(key1);if((key1==null)||(key1==0)||(key1==8)||(key1==9)||(key1==27)||(key1==46)||(key1==22)){return true;}else if((("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ").indexOf(keychar1)>-1)){return true;}else{return false;}}}
...
$('#dropEnquiry').on("submit",function(){debugger
